...
ADMINS = (
    ('Gayathri', 'gayathri3@e.ntu.edu.sg'),
)
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'PATH': os.path.join(os.path.dirname(__file__), 'whoosh_index').replace('\\','/'),
        'STORAGE': 'file',
...
#PyLucene config
LUCENE_INDEX_DIR = os.path.join(os.path.dirname(__file__), 'resources/index').replace('\\','/')
PAGE_RECORDS_VIEW = 10
SEARCH_RESULTS = 50
NUM_RELATED_QUESTION = 5
NUM_CHARACTER = 70
NUM_BEST_FRAGMENTS = 3
SEPARATOR = '...'
HIGHLIGHT_TAG_OPEN  = '<span class=\"highlight\">' 
